...
const MESSAGE_LEGAL_NOTICE = 'При работе с сообщениями, поданными через бот, не применяются положения Федерального закона от 02.05.2006 № 59-ФЗ «О порядке рассмотрения обращений граждан Российской Федерации».';

/** §55 */
export function rulesText(): string {
  const config = getConfig();
  return [
    '📋 Правила подачи сообщения через бот Калужской области по организации обратной связи с жителями',
    '',
    ...
    '',
    '1. Реклама и ссылки на сторонние каналы, сайты и приложения, коммерческие предложения, платные и вредоносные ресурсы любого типа.',
    '2. Нецензурные и оскорбительные выражения в адрес должностных лиц, органов власти и других граждан.',
    '3. Сообщения с целью нанести урон чести и достоинству других граждан.',
    '4. Недостоверная информация, распространяемая под видом достоверной (фейки).',
    '5. Материалы, содержащие пропаганду ненависти, порнографию, сведения о способах совершения преступлений, информацию о нежелательных организациях и другую информацию, нарушающую законодательство Калужской области и Российской Федерации.',
    '6. Многократные повторения одного и того же сообщения, если ответ по существу уже был дан ранее.',
    '7. Отсутствие адреса проблемы.',
    '',
...
export function requesterNamePromptText(): string {
  return [
    ...
    'Можно нажать «Поделиться контактом», чтобы получить ФИО и номер из вашего профиля MAX, либо отправить ФИО текстом.',
    '',
